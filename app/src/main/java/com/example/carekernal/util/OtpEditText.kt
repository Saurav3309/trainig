package com.example.carekernal.utils
...
class OtpEditText : AppCompatEditText {
    ...
    private fun init(context: Context, attrs: AttributeSet?) {
        ...
        mLinesPaint!!.strokeWidth = mLineStroke/3
        mLinesPaint!!.color = ContextCompat.getColor(context,
            R.color.grey
        )
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        paint.color = ContextCompat.getColor(context, R.color.editTextFont)
